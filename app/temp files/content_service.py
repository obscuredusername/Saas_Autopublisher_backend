...
# from app.schemas import KeywordRequest, ScrapingResponse
...
# TARGET_DB_URI = os.getenv('TARGET_DB_URI', 'mongodb://localhost:27017')
...
#             from app.schemas import KeywordItem
